...
int touchthreshold = 600;  //this is the capacitive touch threshold, go for a higher number for more sensitivity if you have fingers as dry as the sahara
int Gthrshld = 700;      //this is the capacitive theshold the gate output will go high
